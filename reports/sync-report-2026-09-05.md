# Job Sync Report — 2026-09-05

Generated: 2026-09-05T11:21:52
...
| Website Jobs | 183 |
| **Sync Score** | **92.5% — Needs Attention** |
...
- [Ship Chandler](https://outreachrecruitment.net/jobs/ship-chandler) — HTTP 0
...
1. Fix 29 job URL(s) not indexed or not passing URL Inspection
2. Fix 42 job URL(s) with zero Search Console impressions
3. Fix 11 job URL(s) ranking worse than average position 20
4. Fix 28 job URL(s) missing target keyword visibility in top queries
...
- **[Site Coordinator](https://outreachrecruitment.net/jobs/site-coordinator)**: avg position 66.5, top query `site:outreachrecruitment.net`
- **[Auto Electrician (Heavy Vehicles)](https://outreachrecruitment.net/jobs/auto-electrician-heavy-vehicles)**: avg position 45.7, top query `auto electrician job`
...
- **[Steel Shutter Installer](https://outreachrecruitment.net/jobs/steel-shutter-installer)**: avg position 57.5, top query `site:outreachrecruitment.net`
- **[Chef De Partie](https://outreachrecruitment.net/jobs/chef-de-partie-4)**: avg position 67.5, top query `site:outreachrecruitment.net`
- **[Trailer Drivers](https://outreachrecruitment.net/jobs/trailer-drivers)**: avg position 29.8, top query `delivery driver recruitment company in malta`
...
- **[Assistance Co-ordinator](https://outreachrecruitment.net/jobs/assistance-co-ordinator)**: avg position 32.0, top query `co-ordinator`
- **[HR Administration Officer](https://outreachrecruitment.net/jobs/hr-administration-officer)**: avg position 34.2, top query `human resources administration jobs`
...
- **[Chef De Partie](https://outreachrecruitment.net/jobs/chef-de-partie-4)**: target `Chef De Partie jobs in Malta`, top query `site:outreachrecruitment.net`
