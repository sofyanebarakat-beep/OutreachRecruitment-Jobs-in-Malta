# Job Sync Report — 2026-09-24

Generated: 2026-09-24T06:24:49

## Summary

| Metric | Value |
|---|---|
| Careers Page Jobs | 138 |
| Careers Jobs Scraped | 138 |
| Website Jobs | 191 |
| **Sync Score** | **87.2% — Needs Attention** |
...
| GSC Problem Groups | 179 |

## Jobs to Add (Missing from Website)

- Proposal Engineer – Energy Solutions
...
3. Fix 35 job URL(s) ranking worse than average position 20
...
- **[Assistant Executive Housekeeper](https://outreachrecruitment.net/jobs/assistant-executive-housekeeper)**: avg position 33.7, top query `executive housekeeper`
...
- **[Client Accountant](https://outreachrecruitment.net/jobs/client-accountant)**: avg position 29.0, top query `accounting recruitment malta`
...
- **[Project Manager - Construction](https://outreachrecruitment.net/jobs/project-manager-construction)**: avg position 34.6, top query `project manager recruitment agency`
...
- **[Corporate Insurance Associate](https://outreachrecruitment.net/jobs/corporate-insurance-associate)**: avg position 44.0, top query `insurance recruitment agency malta`
...
- **[Plumber](https://outreachrecruitment.net/jobs/plumber)**: target `Plumber jobs in Malta`, top query `plumber jobs`
...
2. Remove 48 closed job(s) from website
