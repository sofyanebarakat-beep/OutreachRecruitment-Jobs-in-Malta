# Job Sync Report — 2026-09-09

Generated: 2026-09-09T08:18:39
...
| Careers Jobs Scraped | 160 |
| Website Jobs | 183 |
| **Sync Score** | **90.1% — Needs Attention** |
...
- [Legal Intern](https://outreachrecruitment.net/jobs/legal-intern) — HTTP 0
...
5. Fix 53 job URL(s) missing target keyword visibility in top queries
...
- **[Trailer Drivers](https://outreachrecruitment.net/jobs/trailer-drivers)**: avg position 23.0, top query `agency name`
- **[Assistant Executive Housekeeper](https://outreachrecruitment.net/jobs/assistant-executive-housekeeper)**: avg position 21.8, top query `executive housekeeper`
...
- **[Airline Sales, Reservations, and Ticketing Officer](https://outreachrecruitment.net/jobs/airline-sales-reservations-and-ticketing-officer)**: avg position 35.9, top query `airline ticketing officer`
...
- **[Driver - Malta C License](https://outreachrecruitment.net/jobs/driver-malta-c-license)**: avg position 38.8, top query `malta driver jobs`
...
- **[Corporate Insurance Associate](https://outreachrecruitment.net/jobs/corporate-insurance-associate)**: avg position 40.5, top query `insurance recruitment agency malta`
...
- **[Finance Associate](https://outreachrecruitment.net/jobs/finance-associate)**: avg position 27.0, top query `finance associate`
- **[Commercial Insurance Associate](https://outreachrecruitment.net/jobs/commercial-insurance-associate)**: avg position 36.9, top query `insurance recruitment agency malta`
...
- Careers page advertises 175 jobs but scraper collected 160 — pagination may have been incomplete.

## Actions Required

1. Add 5 missing job(s) to website
2. Remove 21 closed job(s) from website
