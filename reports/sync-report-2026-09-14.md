# Job Sync Report — 2026-09-14

Generated: 2026-09-14T08:43:51
...
1. Fix 34 job URL(s) not indexed or not passing URL Inspection
2. Fix 77 job URL(s) with zero Search Console impressions
3. Fix 31 job URL(s) ranking worse than average position 20
4. Fix 61 job URL(s) missing target keyword visibility in top queries
...
- **[Banqueting F&B Supervisor](https://outreachrecruitment.net/jobs/banqueting-fb-supervisor)**: target `Banqueting F&B Supervisor jobs in Malta`
...
- **[HR Executive](https://outreachrecruitment.net/jobs/hr-executive-st-julians)**: avg position 27.0, top query `hr vacancies`
...
- **[Driver - Malta C License](https://outreachrecruitment.net/jobs/driver-malta-c-license)**: avg position 30.6, top query `malta driver jobs`
...
- **[Delivery Drivers - C1 Malta License](https://outreachrecruitment.net/jobs/delivery-drivers-c1-malta-license)**: avg position 37.6, top query `delivery driver`
...
- **[Finance Associate](https://outreachrecruitment.net/jobs/finance-associate)**: avg position 25.6, top query `finance associate`
- **[Commercial Insurance Associate](https://outreachrecruitment.net/jobs/commercial-insurance-associate)**: avg position 36.3, top query `insurance recruitment agency malta`
...
- **[HR Executive](https://outreachrecruitment.net/jobs/hr-executive-st-julians)**: target `HR Executive jobs in Malta`, top query `hr vacancies`
