# Job Sync Report — 2026-09-16

Generated: 2026-09-16T08:18:35

## Summary

| Metric | Value |
|---|---|
| Careers Page Jobs | 171 |
| Careers Jobs Scraped | 171 |
| Website Jobs | 187 |
| **Sync Score** | **92.7% — Needs Attention** |
...
2. Fix 155 job page(s) with keyword targeting gaps
3. Fix 67 job page(s) missing category-page internal links
4. Fix 185 job page(s) needing deeper content
5. Fix 21 job page(s) not fully eligible for JobPosting rich results
6. Fix 54 possible duplicate/cannibalization pair(s) to review

## Google Search Console Action Plan

1. Fix 32 job URL(s) not indexed or not passing URL Inspection
2. Fix 83 job URL(s) with zero Search Console impressions
3. Fix 31 job URL(s) ranking worse than average position 20
4. Fix 58 job URL(s) missing target keyword visibility in top queries
...
- **[HR Executive](https://outreachrecruitment.net/jobs/hr-executive-st-julians)**: avg position 22.0, top query `hr executive jobs`
...
- **[Assistant Executive Housekeeper](https://outreachrecruitment.net/jobs/assistant-executive-housekeeper)**: avg position 25.5, top query `executive housekeeper`
...
- **[HR Administration Officer](https://outreachrecruitment.net/jobs/hr-administration-officer)**: avg position 36.6, top query `hr administrator vacancies`
...
- **[Client Accountant](https://outreachrecruitment.net/jobs/client-accountant)**: avg position 26.7, top query `accounting recruitment malta`
...
- **[Delivery Drivers - C1 Malta License](https://outreachrecruitment.net/jobs/delivery-drivers-c1-malta-license)**: avg position 40.3, top query `delivery driver`
...
- **[Front Office Agent](https://outreachrecruitment.net/jobs/front-office-agent)** — 4957 words: Missing offer/benefits section
- **[Head of Spa](https://outreachrecruitment.net/jobs/head-of-spa-2)** — 5155 words: Missing offer/benefits section
- **[Night Cleaner](https://outreachrecruitment.net/jobs/night-cleaner)** — 5042 words: Missing offer/benefits section; Salary/baseSalary missing or not specific
...
2. Remove 13 closed job(s) from website
3. Review 2 possible title mismatch(es)
4. Fix 77 SEO issue(s)
5. Review 54 possible duplicate job(s)
