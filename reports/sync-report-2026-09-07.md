# Job Sync Report — 2026-09-07

Generated: 2026-09-07T07:44:33

## Summary

| Metric | Value |
|---|---|
| Careers Page Jobs | 175 |
| Careers Jobs Scraped | 175 |
| Website Jobs | 183 |
...
| Schema Issues | 4 |
| Google Indexing Submitted | 8 |
| Google Indexing Successful | 8 |
| Google Indexing Failed | 0 |
| Average Ranking Readiness | 80.6/100 |
| High-Priority Ranking Jobs | 23 |
| GSC URLs Checked | 183 |
| GSC Problem Groups | 171 |
...
| Front Office Agent | Front Desk Agent | 0.76 |
...
|---|---|---|---|
| [Senior HR Coordinator - Spanish Speaking](https://outreachrecruitment.net/jobs/senior-hr-coordinator-spanish-speaking) | URL_DELETED | auto_close | 200 |
| [Front Office Supervisor](https://outreachrecruitment.net/jobs/front-office-supervisor-2) | URL_DELETED | auto_close | 200 |
| [Front Desk Agent](https://outreachrecruitment.net/jobs/front-desk-agent) | URL_DELETED | auto_close | 200 |
| [Hostess](https://outreachrecruitment.net/jobs/hostess-2) | URL_DELETED | auto_close | 200 |
...
| [Baristas](https://outreachrecruitment.net/jobs/baristas) | URL_DELETED | auto_close | 200 |
| [Assistant Executive Housekeeper](https://outreachrecruitment.net/jobs/assistant-executive-housekeeper) | URL_DELETED | auto_close | 200 |
...
2. Fix 151 job page(s) with keyword targeting gaps
...
1. Fix 35 job URL(s) not indexed or not passing URL Inspection
2. Fix 1 job URL(s) where Google selected a different canonical
3. Fix 84 job URL(s) with zero Search Console impressions
4. Fix 26 job URL(s) ranking worse than average position 20
5. Fix 52 job URL(s) missing target keyword visibility in top queries
...
- **[Maintenance Technician](https://outreachrecruitment.net/jobs/maintenance-technician-2)**: Crawled - currently not indexed
...
- **[Procurement Officer](https://outreachrecruitment.net/jobs/procurement-officer)**: target `Procurement Officer jobs in Malta`
...
- **[Spa Sales / Promotional Staff](https://outreachrecruitment.net/jobs/spa-sales-promotional-staff)**: avg position 27.0, top query `site:outreachrecruitment.net`
...
- **[Auto Electrician (Heavy Vehicles)](https://outreachrecruitment.net/jobs/auto-electrician-heavy-vehicles)**: avg position 50.2, top query `auto electrician job`
...
- **[Chef De Partie](https://outreachrecruitment.net/jobs/chef-de-partie-4)**: avg position 50.5, top query `offerta di lavoro`
- **[Trailer Drivers](https://outreachrecruitment.net/jobs/trailer-drivers)**: avg position 26.7, top query `agency name`
- **[Assistant Executive Housekeeper](https://outreachrecruitment.net/jobs/assistant-executive-housekeeper)**: avg position 20.9, top query `assistant housekeeper`
...
- **[Assistance Co-ordinator](https://outreachrecruitment.net/jobs/assistance-co-ordinator)**: avg position 29.4, top query `co ordinator`
- **[HR Administration Officer](https://outreachrecruitment.net/jobs/hr-administration-officer)**: avg position 37.0, top query `human resources administration jobs`
- **[Pool Attendants](https://outreachrecruitment.net/jobs/pool-attendants)**: avg position 21.5, top query `site:outreachrecruitment.net`
...
- **[Client Accountant](https://outreachrecruitment.net/jobs/client-accountant)**: avg position 26.2, top query `accounting recruitment malta`
- **[Project Manager - Construction](https://outreachrecruitment.net/jobs/project-manager-construction)**: avg position 35.7, top query `project manager recruitment agency`
- **[Airline Sales, Reservations, and Ticketing Officer](https://outreachrecruitment.net/jobs/airline-sales-reservations-and-ticketing-officer)**: avg position 39.9, top query `airline ticketing officer`
...
- **[Driver - Malta C License](https://outreachrecruitment.net/jobs/driver-malta-c-license)**: avg position 46.4, top query `malta driver jobs`
- **[Assistant Laboratory Manager - Construction Materials](https://outreachrecruitment.net/jobs/assistant-laboratory-manager-construction-materials)**: avg position 72.7, top query `site:outreachrecruitment.net`
- **[Corporate Insurance Associate](https://outreachrecruitment.net/jobs/corporate-insurance-associate)**: avg position 42.1, top query `insurance recruitment agency malta`
- **[Delivery Drivers - C1 Malta License](https://outreachrecruitment.net/jobs/delivery-drivers-c1-malta-license)**: avg position 34.8, top query `delivery driver`
- **[Lead Microsoft 365 Architect Modern Work & Security](https://outreachrecruitment.net/jobs/lead-microsoft-365-architect-modern-work-security)**: avg position 21.7, top query `microsoft modern work and security`
- **[Finance Associate](https://outreachrecruitment.net/jobs/finance-associate)**: avg position 28.5, top query `finance associate`
- **[Commercial Insurance Associate](https://outreachrecruitment.net/jobs/commercial-insurance-associate)**: avg position 35.8, top query `insurance recruitment agency malta`
- **[Aluminum Install and Fabrication Foreman](https://outreachrecruitment.net/jobs/aluminum-install-and-fabrication-foreman)**: avg position 20.6, top query `malta aluminium fabrication vacancy`
- **[Barista](https://outreachrecruitment.net/jobs/barista-3)**: avg position 33.5, top query `barista`
...
- **[Housekeeper](https://outreachrecruitment.net/jobs/housekeeper)**: target `Housekeeper jobs in Malta`, top query `site:outreachrecruitment.net`
...
- **[Pool Attendants](https://outreachrecruitment.net/jobs/pool-attendants)**: target `Pool Attendants jobs in Malta`, top query `site:outreachrecruitment.net`
...
- **[Kitchen Assistant](https://outreachrecruitment.net/jobs/kitchen-assistant)**: target `Kitchen Assistant jobs in Malta`, top query `site:outreachrecruitment.net`
...
2. Remove 8 closed job(s) from website
3. Review 3 possible title mismatch(es)
