# Job Sync Report — 2026-09-02

Generated: 2026-09-02T09:12:29

## Summary

| Metric | Value |
|---|---|
| Careers Page Jobs | 182 |
| Careers Jobs Scraped | 182 |
| Website Jobs | 180 |
| **Sync Score** | **93.0% — Needs Attention** |
...
- Assistance Operations Coordinator
- Procurement Officer
...
- [Delivery Man](https://outreachrecruitment.net/jobs/delivery-man) — HTTP 0
...
1. Fix 33 job URL(s) not indexed or not passing URL Inspection
2. Fix 1 job URL(s) where Google selected a different canonical
3. Fix 94 job URL(s) with zero Search Console impressions
4. Fix 14 job URL(s) ranking worse than average position 20
5. Fix 42 job URL(s) missing target keyword visibility in top queries
...
- **[Trailer Drivers](https://outreachrecruitment.net/jobs/trailer-drivers)**: avg position 29.2, top query `delivery driver recruitment company in malta`
...
- **[Driver - Malta C License](https://outreachrecruitment.net/jobs/driver-malta-c-license)**: avg position 29.0, top query `malta driver jobs`
- **[Corporate Insurance Associate](https://outreachrecruitment.net/jobs/corporate-insurance-associate)**: avg position 43.5, top query `insurance recruitment agency malta`
...
- **[Auditor](https://outreachrecruitment.net/jobs/auditor)**: avg position 20.4, top query `auditor malta`
- **[Finance Associate](https://outreachrecruitment.net/jobs/finance-associate)**: avg position 31.1, top query `finance associate`
...
- **[Driver - Malta C License](https://outreachrecruitment.net/jobs/driver-malta-c-license)**: target `Driver - Malta C License jobs in Malta`, top query `malta driver jobs`
...
| [Delivery Man](https://outreachrecruitment.net/jobs/delivery-man) | Engineering & Maintenance | 46/100 | Delivery Man jobs in Malta | Missing meta description; JobPosting schema needs fixes; Target phrase missing: Delivery Man jobs in Malta |
...
| Engineering & Maintenance | 31 | 77.5/100 | 18 |
