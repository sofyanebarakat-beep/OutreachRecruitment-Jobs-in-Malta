# Job Sync Report — 2026-09-06

Generated: 2026-09-06T10:34:16
...
| Website Jobs | 183 |
| **Sync Score** | **91.4% — Needs Attention** |
...
- [Application Developer (Drupal)](https://outreachrecruitment.net/jobs/application-developer-drupal) — HTTP 0
...
3. Fix 83 job URL(s) with zero Search Console impressions
4. Fix 25 job URL(s) ranking worse than average position 20
...
- **[Trailer Drivers](https://outreachrecruitment.net/jobs/trailer-drivers)**: avg position 28.8, top query `delivery driver recruitment company in malta`
...
- **[Finance Associate](https://outreachrecruitment.net/jobs/finance-associate)**: avg position 28.8, top query `finance associate`
- **[Commercial Insurance Associate](https://outreachrecruitment.net/jobs/commercial-insurance-associate)**: avg position 35.3, top query `insurance recruitment agency malta`
...
5. Fix 73 SEO issue(s)
6. Review 51 possible duplicate job(s)
