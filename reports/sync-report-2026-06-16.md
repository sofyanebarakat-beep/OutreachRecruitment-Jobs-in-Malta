# Job Sync Report — 2026-06-16

Generated: 2026-06-16T09:13:10
...
- https://outreachrecruitment.net/jobs/payables-finance-executive
...
| [Restaurant Manager](https://outreachrecruitment.net/jobs/restaurant-manager) | [Real Estate Managers](https://outreachrecruitment.net/jobs/real-estate-managers) | 0.74 |
...
| [Restaurant Manager](https://outreachrecruitment.net/jobs/restaurant-manager) | [Account Manager](https://outreachrecruitment.net/jobs/account-manager) | 0.73 |
...
1. Fix 72 job URL(s) not indexed or not passing URL Inspection
2. Fix 148 job URL(s) with zero Search Console impressions

## Jobs Not Indexed by Google

- **[Payables Finance Executive](https://outreachrecruitment.net/jobs/payables-finance-executive)**: URL is unknown to Google
- **[Sales Office Coordinator](https://outreachrecruitment.net/jobs/sales-office-coordinator)**: URL is unknown to Google
- **[Maintenance Technician](https://outreachrecruitment.net/jobs/maintenance-technician)**: URL is unknown to Google
- **[Auditor Doctor](https://outreachrecruitment.net/jobs/auditor-doctor)**: URL is unknown to Google
- **[Nurse Advisor](https://outreachrecruitment.net/jobs/nurse-advisor)**: URL is unknown to Google
- **[Summer Waiter - Mellieha](https://outreachrecruitment.net/jobs/summer-waiter-mellieha)**: URL is unknown to Google
- **[Purchasing Officer](https://outreachrecruitment.net/jobs/purchasing-officer)**: URL is unknown to Google
- **[HSSE Coordinator](https://outreachrecruitment.net/jobs/hsse-coordinator)**: URL is unknown to Google
- **[Restaurant Supervisor](https://outreachrecruitment.net/jobs/restaurant-supervisor)**: URL is unknown to Google
- **[Chef de Partie](https://outreachrecruitment.net/jobs/chef-de-partie)**: URL is unknown to Google
- **[Assistant Pizza Chef](https://outreachrecruitment.net/jobs/assistant-pizza-chef)**: URL is unknown to Google
- **[Production Chef](https://outreachrecruitment.net/jobs/production-chef)**: URL is unknown to Google
- **[Bar attendant](https://outreachrecruitment.net/jobs/bar-attendant)**: URL is unknown to Google
- **[Barista](https://outreachrecruitment.net/jobs/barista)**: URL is unknown to Google
- **[Compliance Manager](https://outreachrecruitment.net/jobs/compliance-manager)**: URL is unknown to Google
- **[Pool Attendants](https://outreachrecruitment.net/jobs/pool-attendants)**: URL is unknown to Google
- **[Head Chef](https://outreachrecruitment.net/jobs/head-chef)**: URL is unknown to Google
- **[Level 2 Platform Ops Engineer](https://outreachrecruitment.net/jobs/level-2-platform-ops-engineer)**: URL is unknown to Google
- **[Sales Shift Manager](https://outreachrecruitment.net/jobs/sales-shift-manager)**: URL is unknown to Google
- **[Senior Plant Technician – Hotel Operations & Maintenance](https://outreachrecruitment.net/jobs/senior-plant-technician-hotel-operations-maintenance)**: URL is unknown to Google
- **[Sous Chef](https://outreachrecruitment.net/jobs/sous-chef)**: URL is unknown to Google
- **[Supervisor](https://outreachrecruitment.net/jobs/supervisor)**: URL is unknown to Google
- **[Marketing Administrator](https://outreachrecruitment.net/jobs/marketing-administrator)**: URL is unknown to Google
- **[Retail Sales Associate](https://outreachrecruitment.net/jobs/retail-sales-associate)**: URL is unknown to Google
- **[Executive Operations Manager](https://outreachrecruitment.net/jobs/executive-operations-manager)**: URL is unknown to Google
- **[Kitchen Manager](https://outreachrecruitment.net/jobs/kitchen-manager)**: URL is unknown to Google
...
- **[Heavy Machine Operator](https://outreachrecruitment.net/jobs/heavy-machine-operator)**: URL is unknown to Google
...
- **[Restaurant Manager](https://outreachrecruitment.net/jobs/restaurant-manager)**: target `Restaurant Manager jobs in Malta`
...
- **[Runners](https://outreachrecruitment.net/jobs/runners)**: target `Runners jobs in Malta`
...
- **[Hairdresser](https://outreachrecruitment.net/jobs/hairdresser)**: target `Hairdresser jobs in Malta`
...
| [Payables Finance Executive](https://outreachrecruitment.net/jobs/payables-finance-executive) | Finance & Accounting | 71/100 | Payables Finance Executive jobs in Malta | Missing from sitemap; Meta title missing job/jobs intent; Target phrase missing: Payables Finance Executive jobs in Malta |
...
| IT & Technology | 7 | 83.7/100 | 3 |
| Administration | 12 | 85.1/100 | 4 |
| Logistics | 9 | 86.0/100 | 4 |
| Finance & Accounting | 14 | 86.3/100 | 4 |
| Healthcare & Insurance | 1 | 87.0/100 | 0 |
| Engineering & Maintenance | 30 | 87.3/100 | 7 |
...
- **[Application Developer (.NET, SharePoint) - Hybrid](https://outreachrecruitment.net/jobs/application-developer-net-sharepoint-hybrid)** — target `Application Developer (.NET, SharePoint) - Hybrid jobs in Malta`: Meta title does not include exact job title; Meta title missing job/jobs intent; Meta description does not include exact job title; Target phrase missing: Application Developer (.NET, SharePoint) - Hybrid jobs in Malta
...
1. Update sitemap — 1 page(s) missing
2. Review 86 possible duplicate job(s)
3. Improve 2 high-priority ranking page(s) below 70/100
