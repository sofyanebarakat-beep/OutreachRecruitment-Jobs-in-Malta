# Job Sync Report — 2026-09-01

Generated: 2026-09-01T09:04:17
...
| Careers Jobs Scraped | 180 |
| Website Jobs | 180 |
| **Sync Score** | **93.5% — Needs Attention** |
...
- [Public Area Cleaner](https://outreachrecruitment.net/jobs/public-area-cleaner) — HTTP 0
...
|---|---|---|---|
| [Deli Counter Assistant / Salumeria Specialist](https://outreachrecruitment.net/jobs/deli-counter-assistant-salumeria-specialist) | URL_DELETED | auto_close | 200 |
| [Application Developer (Drupal)](https://outreachrecruitment.net/jobs/application-developer-drupal) | URL_DELETED | auto_close | 200 |
...
4. Fix 14 job URL(s) ranking worse than average position 20
5. Fix 39 job URL(s) missing target keyword visibility in top queries
...
- **[Accounts Billing Officer](https://outreachrecruitment.net/jobs/accounts-billing-officer)**: Alternate page with proper canonical tag
- **[Senior Waiter / Sommelier](https://outreachrecruitment.net/jobs/senior-waiter-sommelier)**: Alternate page with proper canonical tag
...
- **[Sales Engineer](https://outreachrecruitment.net/jobs/sales-engineer)**: Alternate page with proper canonical tag
...
- **[Sales Executive](https://outreachrecruitment.net/jobs/sales-executive-2)**: Alternate page with proper canonical tag
...
- **[Heavy Equipment Mechanic](https://outreachrecruitment.net/jobs/heavy-equipment-mechanic-2)**: target `Heavy Equipment Mechanic jobs in Malta`
- **[Spa Receptionist](https://outreachrecruitment.net/jobs/spa-receptionist)**: target `Spa Receptionist jobs in Malta`
- **[Spa Sales / Promotional Staff](https://outreachrecruitment.net/jobs/spa-sales-promotional-staff)**: target `Spa Sales / Promotional Staff jobs in Malta`
...
- **[Finance Officer](https://outreachrecruitment.net/jobs/finance-officer)**: target `Finance Officer jobs in Malta`
- **[Learning & Development Executive - Hybrid](https://outreachrecruitment.net/jobs/learning-development-executive-hybrid)**: target `Learning & Development Executive - Hybrid jobs in Malta`
...
- **[Site Coordinator](https://outreachrecruitment.net/jobs/site-coordinator)**: target `Site Coordinator jobs in Malta`
- **[Auto Electrician (Heavy Vehicles)](https://outreachrecruitment.net/jobs/auto-electrician-heavy-vehicles)**: target `Auto Electrician (Heavy Vehicles) jobs in Malta`
...
- **[Delivery Man](https://outreachrecruitment.net/jobs/delivery-man)**: target `Delivery Man jobs in Malta`
...
- **[Maintenance Technician](https://outreachrecruitment.net/jobs/maintenance-technician)**: avg position 24.0, top query `malta`
...
- **[Project Manager - Construction](https://outreachrecruitment.net/jobs/project-manager-construction)**: avg position 38.3, top query `project management recruitment`
- **[Corporate Insurance Associate](https://outreachrecruitment.net/jobs/corporate-insurance-associate)**: avg position 43.6, top query `insurance recruitment agency malta`
...
- **[Auditor](https://outreachrecruitment.net/jobs/auditor)**: avg position 20.6, top query `auditor malta`
- **[Finance Associate](https://outreachrecruitment.net/jobs/finance-associate)**: avg position 34.9, top query `finance recruitment agencies`
...
- **[Waiters](https://outreachrecruitment.net/jobs/waiters)**: avg position 36.0, top query `waiter jobs in malta for foreigners`
...
- **[Maintenance Technician](https://outreachrecruitment.net/jobs/maintenance-technician)**: target `Maintenance Technician jobs in Malta`, top query `malta`
...
- **[Hairdresser](https://outreachrecruitment.net/jobs/hairdresser)**: target `Hairdresser jobs in Malta`, top query `hairdresser vacancies`
...
- **[Delivery Drivers - C1 Malta License](https://outreachrecruitment.net/jobs/delivery-drivers-c1-malta-license)**: target `Delivery Drivers - C1 Malta License jobs in Malta`, top query `delivery driver`
