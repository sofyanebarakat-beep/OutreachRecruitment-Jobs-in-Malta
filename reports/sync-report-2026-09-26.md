# Job Sync Report — 2026-09-26

Generated: 2026-09-26T10:31:54

## Summary

| Metric | Value |
|---|---|
| Careers Page Jobs | 127 |
| Careers Jobs Scraped | 127 |
| Website Jobs | 192 |
| **Sync Score** | **85.6% — Needs Attention** |
...
2. Fix 160 job page(s) with keyword targeting gaps
...
3. Fix 34 job URL(s) ranking worse than average position 20
...
- **[Trailer Drivers](https://outreachrecruitment.net/jobs/trailer-drivers)**: Page with redirect
...
- **[Proposal Engineer – Energy Solutions](https://outreachrecruitment.net/jobs/proposal-engineer-energy-solutions)**: target `Proposal Engineer – Energy Solutions jobs in Malta`
...
- **[HR Executive](https://outreachrecruitment.net/jobs/hr-executive-st-julians)**: avg position 28.2, top query `executive recruitment malta`
...
- **[Assistant Executive Housekeeper](https://outreachrecruitment.net/jobs/assistant-executive-housekeeper)**: avg position 28.0, top query `executive housekeeper`
...
- **[HR Administration Officer](https://outreachrecruitment.net/jobs/hr-administration-officer)**: avg position 44.0, top query `hr administrator vacancies`
- **[Kitchen Porter](https://outreachrecruitment.net/jobs/kitchen-porter)**: avg position 21.5, top query `kitchen porter jobs`
- **[Chef de Partie](https://outreachrecruitment.net/jobs/chef-de-partie)**: avg position 23.4, top query `chef de partie`
- **[Pool Attendants](https://outreachrecruitment.net/jobs/pool-attendants)**: avg position 25.0, top query `site:outreachrecruitment.net`
- **[Kitchen Assistant](https://outreachrecruitment.net/jobs/kitchen-assistant)**: avg position 39.7, top query `kitchen assistant`
- **[Client Accountant](https://outreachrecruitment.net/jobs/client-accountant)**: avg position 29.7, top query `accounting recruitment malta`
...
- **[Project Manager - Construction](https://outreachrecruitment.net/jobs/project-manager-construction)**: avg position 33.9, top query `project manager recruitment agency`
...
- **[Driver - Malta C License](https://outreachrecruitment.net/jobs/driver-malta-c-license)**: avg position 21.4, top query `malta driver jobs`
...
- **[Bartender in Gozo](https://outreachrecruitment.net/jobs/bartender-in-gozo)**: avg position 39.5, top query `bartender job in malta`
...
- **[Delivery Drivers - C1 Malta License](https://outreachrecruitment.net/jobs/delivery-drivers-c1-malta-license)**: avg position 61.2, top query `delivery driver recruitment company in malta`
...
- **[Storekeeper](https://outreachrecruitment.net/jobs/storekeeper-zebbug)**: target `Storekeeper jobs in Malta`, top query `storekeeper`
...
- **[Public Area Cleaner](https://outreachrecruitment.net/jobs/public-area-cleaner)**: target `Public Area Cleaner jobs in Malta`, top query `public cleaning jobs`
...
- **[Customer Care Team Leader](https://outreachrecruitment.net/jobs/customer-care-team-leader)**: target `Customer Care Team Leader jobs in Malta`, top query `team leader customer service jobs`
...
- **[Application Developer (Drupal)](https://outreachrecruitment.net/jobs/application-developer-drupal)**: target `Application Developer (Drupal) jobs in Malta`, top query `drupal jobs`
...
- **[Estimator](https://outreachrecruitment.net/jobs/estimator)**: target `Estimator jobs in Malta`, top query `estimators`
...
| Engineering & Maintenance | 32 | 78.7/100 | 16 |
| IT | 1 | 80.0/100 | 1 |
...
| Finance & Accounting | 17 | 86.7/100 | 6 |
| Construction | 1 | 88.0/100 | 0 |
| Manufacturing Sector | 1 | 89.0/100 | 0 |
| IT & Technology | 3 | 91.3/100 | 1 |
| Healthcare | 2 | 93.0/100 | 0 |

## Keyword Target Gaps

- **[Proposal Engineer – Energy Solutions](https://outreachrecruitment.net/jobs/proposal-engineer-energy-solutions)** — target `Proposal Engineer – Energy Solutions jobs in Malta`: Meta title does not include exact job title; Target phrase missing: Proposal Engineer – Energy Solutions jobs in Malta
...
- **[Proposal Engineer – Energy Solutions](https://outreachrecruitment.net/jobs/proposal-engineer-energy-solutions)** — 5335 words: Salary/baseSalary missing or not specific
...
2. Remove 59 closed job(s) from website
3. Review 2 possible title mismatch(es)
4. Fix 75 SEO issue(s)
