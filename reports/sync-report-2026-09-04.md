# Job Sync Report — 2026-09-04

Generated: 2026-09-04T07:38:30

## Summary

| Metric | Value |
|---|---|
| Careers Page Jobs | 184 |
| Careers Jobs Scraped | 184 |
| Website Jobs | 182 |
| **Sync Score** | **94.0% — Needs Attention** |
...
2. Fix 150 job page(s) with keyword targeting gaps
3. Fix 63 job page(s) missing category-page internal links
4. Fix 181 job page(s) needing deeper content
5. Fix 21 job page(s) not fully eligible for JobPosting rich results
6. Fix 51 possible duplicate/cannibalization pair(s) to review
...
5. Fix 40 job URL(s) missing target keyword visibility in top queries
...
- **[Trailer Drivers](https://outreachrecruitment.net/jobs/trailer-drivers)**: avg position 29.3, top query `delivery driver recruitment company in malta`
- **[Assistant Executive Housekeeper](https://outreachrecruitment.net/jobs/assistant-executive-housekeeper)**: avg position 20.6, top query `assistant housekeeper`
...
- **[Project Manager - Construction](https://outreachrecruitment.net/jobs/project-manager-construction)**: avg position 36.6, top query `project manager recruitment agency`
- **[Airline Sales, Reservations, and Ticketing Officer](https://outreachrecruitment.net/jobs/airline-sales-reservations-and-ticketing-officer)**: avg position 21.0, top query `airline ticketing officer`
...
- **[Corporate Insurance Associate](https://outreachrecruitment.net/jobs/corporate-insurance-associate)**: avg position 42.7, top query `insurance recruitment agency malta`
...
- **[Finance Associate](https://outreachrecruitment.net/jobs/finance-associate)**: avg position 30.0, top query `finance associate`
- **[Commercial Insurance Associate](https://outreachrecruitment.net/jobs/commercial-insurance-associate)**: avg position 35.1, top query `insurance recruitment agency malta`
- **[Waiters](https://outreachrecruitment.net/jobs/waiters)**: avg position 36.0, top query `waiter jobs in malta for foreigners`
- **[Barista](https://outreachrecruitment.net/jobs/barista-3)**: avg position 21.0, top query `barista`
...
- **[Project Manager - Construction](https://outreachrecruitment.net/jobs/project-manager-construction)**: target `Project Manager - Construction jobs in Malta`, top query `project manager recruitment agency`
...
- **[Assistance Operations Coordinator](https://outreachrecruitment.net/jobs/assistance-operations-coordinator)** — 5119 words: Salary/baseSalary missing or not specific
...
4. Fix 74 SEO issue(s)
5. Review 51 possible duplicate job(s)
6. Fix 4 structured data schema issue(s)
7. Improve 23 high-priority ranking page(s) below 70/100
