# Job Sync Report — 2026-08-29

Generated: 2026-08-29T10:54:54
...
| Website Jobs | 180 |
| **Sync Score** | **80.7% — Needs Attention** |
...
| SEO Issues | 71 |
| Sitemap Missing | 0 |
| Possible Duplicates | 50 |
| Schema Issues | 4 |
| Google Indexing Submitted | 0 |
| Google Indexing Successful | 0 |
| Google Indexing Failed | 0 |
| Average Ranking Readiness | 80.6/100 |
| High-Priority Ranking Jobs | 23 |
| GSC URLs Checked | 180 |
| GSC Problem Groups | 167 |
...
- **Heavy Equipment Mechanic** (`https://outreachrecruitment.net/jobs/heavy-equipment-mechanic-2`): Meta title too long (68 chars); Meta description too long (174 chars)
...
1. Fix 23 high-priority job page(s) below 70/100
2. Fix 148 job page(s) with keyword targeting gaps
3. Fix 62 job page(s) missing category-page internal links
4. Fix 180 job page(s) needing deeper content
5. Fix 21 job page(s) not fully eligible for JobPosting rich results
6. Fix 50 possible duplicate/cannibalization pair(s) to review

## Google Search Console Action Plan

1. Fix 36 job URL(s) not indexed or not passing URL Inspection
2. Fix 2 job URL(s) where Google selected a different canonical
3. Fix 89 job URL(s) with zero Search Console impressions
4. Fix 12 job URL(s) ranking worse than average position 20
5. Fix 41 job URL(s) missing target keyword visibility in top queries
6. Fix 4 job URL(s) with rich result issues

## Jobs Not Indexed by Google

- **[Restaurant Supervisor](https://outreachrecruitment.net/jobs/restaurant-supervisor-2)**: URL is unknown to Google
...
- **[Heavy Equipment Mechanic](https://outreachrecruitment.net/jobs/heavy-equipment-mechanic-2)**: URL is unknown to Google
...
- **[Front Office Supervisor](https://outreachrecruitment.net/jobs/front-office-supervisor)**: Alternate page with proper canonical tag

## Canonical Conflicts

- **[Marine Turner](https://outreachrecruitment.net/jobs/marine-turner)**: user `https://outreachrecruitment.net/jobs/marine-turner-malta` vs Google `https://outreachrecruitment.net/jobs/marine-turner/`
...
- **[HR Executive](https://outreachrecruitment.net/jobs/hr-executive-st-julians)**: target `HR Executive jobs in Malta`
- **[Operations Supervisor](https://outreachrecruitment.net/jobs/operations-supervisor)**: target `Operations Supervisor jobs in Malta`
- **[Spa Receptionist](https://outreachrecruitment.net/jobs/spa-receptionist)**: target `Spa Receptionist jobs in Malta`
- **[Legal Intern](https://outreachrecruitment.net/jobs/legal-intern)**: target `Legal Intern jobs in Malta`
...
- **[Heavy Equipment Mechanic](https://outreachrecruitment.net/jobs/heavy-equipment-mechanic)**: target `Heavy Equipment Mechanic jobs in Malta`
- **[Steel Shutter Installer](https://outreachrecruitment.net/jobs/steel-shutter-installer)**: target `Steel Shutter Installer jobs in Malta`
- **[Junior Revenue & Accounts Analyst](https://outreachrecruitment.net/jobs/junior-revenue-accounts-analyst)**: target `Junior Revenue & Accounts Analyst jobs in Malta`
...
- **[Marine Turner](https://outreachrecruitment.net/jobs/marine-turner)**: target `Marine Turner jobs in Malta`
...
- **[Trailer Drivers](https://outreachrecruitment.net/jobs/trailer-drivers)**: avg position 30.8, top query `delivery driver recruitment company in malta`
- **[Assistant Executive Housekeeper](https://outreachrecruitment.net/jobs/assistant-executive-housekeeper)**: avg position 20.2, top query `assistant housekeeper`
...
- **[Project Manager - Construction](https://outreachrecruitment.net/jobs/project-manager-construction)**: avg position 39.6, top query `project management recruitment`
- **[Corporate Insurance Associate](https://outreachrecruitment.net/jobs/corporate-insurance-associate)**: avg position 43.8, top query `insurance recruitment agency malta`
...
- **[Commercial Insurance Associate](https://outreachrecruitment.net/jobs/commercial-insurance-associate)**: avg position 33.4, top query `insurance recruitment agency malta`
...
- **[Maintenance Technician](https://outreachrecruitment.net/jobs/maintenance-technician)**: target `Maintenance Technician jobs in Malta`, top query `maintenance jobs malta`
...
- **[Customer Contact Agent](https://outreachrecruitment.net/jobs/customer-contact-agent)**: target `Customer Contact Agent jobs in Malta`, top query `outreach malta`
...
- **[Pool Attendants](https://outreachrecruitment.net/jobs/pool-attendants)**: target `Pool Attendants jobs in Malta`, top query `swimming pool attendant jobs`
...
- **[Motor Vehicle Mechanic/Technician](https://outreachrecruitment.net/jobs/motor-vehicle-mechanictechnician)**: target `Motor Vehicle Mechanic/Technician jobs in Malta`, top query `malta agents`
...
| [Tank Cleaner](https://outreachrecruitment.net/jobs/tank-cleaner) | Marine & Shipping | 46/100 | Tank Cleaner jobs in Malta | JobPosting schema needs fixes; Target phrase missing: Tank Cleaner jobs in Malta; Not linked from a category jobs page |

## Category Ranking Report

| Category | Jobs | Average Score | Weak Jobs |
|---|---|---|---|
| Marine & Shipping | 11 | 47.9/100 | 10 |
| Hospitality & Hotel Jobs | 1 | 73.0/100 | 1 |
| Marine | 2 | 76.0/100 | 2 |
| HR & Recruitment | 3 | 77.0/100 | 3 |
| Engineering & Maintenance | 31 | 77.8/100 | 18 |
| Transport | 3 | 78.3/100 | 3 |
| IT | 1 | 80.0/100 | 1 |
| Management | 2 | 80.0/100 | 2 |
| Logistics | 7 | 80.9/100 | 3 |
| Administration | 11 | 82.6/100 | 5 |
| General | 41 | 83.3/100 | 25 |
| Hospitality | 24 | 84.4/100 | 12 |
| Sales | 13 | 84.7/100 | 6 |
| Finance & Accounting | 16 | 86.2/100 | 6 |
| Insurance | 3 | 86.3/100 | 2 |
| Wellness | 3 | 87.0/100 | 1 |
...
- **[Head Chef](https://outreachrecruitment.net/jobs/head-chef-steakhouse)** — target `Head Chef jobs in Malta`: Target phrase missing: Head Chef jobs in Malta
...
- **[Deli Counter Assistant / Salumeria Specialist](https://outreachrecruitment.net/jobs/deli-counter-assistant-salumeria-specialist)** — target `Deli Counter Assistant / Salumeria Specialist jobs in Malta`: Target phrase missing: Deli Counter Assistant / Salumeria Specialist jobs in Malta
- **[Chef De Partie](https://outreachrecruitment.net/jobs/chef-de-partie-4)** — target `Chef De Partie jobs in Malta`: Target phrase missing: Chef De Partie jobs in Malta
...
- **[Heavy Equipment Mechanic](https://outreachrecruitment.net/jobs/heavy-equipment-mechanic-2)**: Not linked from a category jobs page
...
- **[HR Executive](https://outreachrecruitment.net/jobs/hr-executive-st-julians)** — 4974 words: Salary/baseSalary missing or not specific
- **[Operations Supervisor](https://outreachrecruitment.net/jobs/operations-supervisor)** — 5104 words: Salary/baseSalary missing or not specific
- **[Restaurant Supervisor](https://outreachrecruitment.net/jobs/restaurant-supervisor-2)** — 5041 words: Salary/baseSalary missing or not specific
- **[Front Office Supervisor](https://outreachrecruitment.net/jobs/front-office-supervisor-2)** — 4998 words: Salary/baseSalary missing or not specific
- **[Heavy Equipment Mechanic](https://outreachrecruitment.net/jobs/heavy-equipment-mechanic-2)** — 4855 words: Salary/baseSalary missing or not specific
- **[Spa Receptionist](https://outreachrecruitment.net/jobs/spa-receptionist)** — 4528 words: Salary/baseSalary missing or not specific
- **[Spa Sales / Promotional Staff](https://outreachrecruitment.net/jobs/spa-sales-promotional-staff)** — 4501 words: Salary/baseSalary missing or not specific
- **[Spa Supervisor](https://outreachrecruitment.net/jobs/spa-supervisor)** — 4459 words: Salary/baseSalary missing or not specific
- **[Legal Intern](https://outreachrecruitment.net/jobs/legal-intern)** — 4466 words: Salary/baseSalary missing or not specific
- **[Accounts Billing Officer](https://outreachrecruitment.net/jobs/accounts-billing-officer)** — 4491 words: Salary/baseSalary missing or not specific
- **[Finance Officer](https://outreachrecruitment.net/jobs/finance-officer)** — 4520 words: Salary/baseSalary missing or not specific
- **[Learning & Development Executive - Hybrid](https://outreachrecruitment.net/jobs/learning-development-executive-hybrid)** — 4550 words: Salary/baseSalary missing or not specific
- **[Senior Claims Executive](https://outreachrecruitment.net/jobs/senior-claims-executive)** — 4637 words: Salary/baseSalary missing or not specific
- **[Payment Clearing Specialist](https://outreachrecruitment.net/jobs/payment-clearing-specialist)** — 5028 words: Salary/baseSalary missing or not specific
- **[Site Coordinator](https://outreachrecruitment.net/jobs/site-coordinator)** — 5084 words: Salary/baseSalary missing or not specific
...
- **[Junior Revenue & Accounts Analyst](https://outreachrecruitment.net/jobs/junior-revenue-accounts-analyst)** — 4675 words: Salary/baseSalary missing or not specific
...
- **[Head Chef](https://outreachrecruitment.net/jobs/head-chef-steakhouse)** — 4852 words: Salary/baseSalary missing or not specific
- **[Senior Waiter / Sommelier](https://outreachrecruitment.net/jobs/senior-waiter-sommelier)** — 4714 words: Missing offer/benefits section; Salary/baseSalary missing or not specific
...
- **[Sales Agent](https://outreachrecruitment.net/jobs/sales-agent)** — 4648 words: Missing offer/benefits section; Salary/baseSalary missing or not specific
...
- **[Deli Counter Assistant / Salumeria Specialist](https://outreachrecruitment.net/jobs/deli-counter-assistant-salumeria-specialist)** — 4990 words: Salary/baseSalary missing or not specific
- **[Chef De Partie](https://outreachrecruitment.net/jobs/chef-de-partie-4)** — 4962 words: Salary/baseSalary missing or not specific
- **[Baristas](https://outreachrecruitment.net/jobs/baristas)** — 4814 words: Missing offer/benefits section; Salary/baseSalary missing or not specific
...
- Careers page advertises 180 jobs but scraper collected 90 — pagination may have been incomplete.

## Actions Required

1. Add 3 missing job(s) to website
2. Remove 84 closed job(s) from website
3. Review 2 possible title mismatch(es)
4. Fix 1 broken page(s)
5. Fix 71 SEO issue(s)
6. Review 50 possible duplicate job(s)
7. Fix 4 structured data schema issue(s)
8. Improve 23 high-priority ranking page(s) below 70/100
