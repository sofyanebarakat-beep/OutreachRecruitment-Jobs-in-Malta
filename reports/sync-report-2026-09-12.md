# Job Sync Report — 2026-09-12

Generated: 2026-09-12T06:54:08

## Summary

| Metric | Value |
|---|---|
| Careers Page Jobs | 174 |
| Careers Jobs Scraped | 174 |
| Website Jobs | 184 |
| **Sync Score** | **92.3% — Needs Attention** |
| Missing from Website | 7 |
| Extra on Website | 11 |
| Title Mismatches | 3 |
...
2. Fix 152 job page(s) with keyword targeting gaps
3. Fix 65 job page(s) missing category-page internal links
4. Fix 182 job page(s) needing deeper content
...
4. Fix 59 job URL(s) missing target keyword visibility in top queries
5. Fix 4 job URL(s) with rich result issues

## Jobs Not Indexed by Google

- **[Banqueting F&B Supervisor](https://outreachrecruitment.net/jobs/banqueting-fb-supervisor)**: URL is unknown to Google
...
- **[Trailer Drivers](https://outreachrecruitment.net/jobs/trailer-drivers)**: avg position 21.9, top query `agency name`
...
- **[Project Manager - Construction](https://outreachrecruitment.net/jobs/project-manager-construction)**: avg position 37.6, top query `project manager recruitment agency`
- **[Airline Sales, Reservations, and Ticketing Officer](https://outreachrecruitment.net/jobs/airline-sales-reservations-and-ticketing-officer)**: avg position 31.2, top query `airline ticketing officer`
...
- **[Commercial Insurance Associate](https://outreachrecruitment.net/jobs/commercial-insurance-associate)**: avg position 37.0, top query `insurance recruitment agency malta`
...
- **[Banqueting F&B Supervisor](https://outreachrecruitment.net/jobs/banqueting-fb-supervisor)** — 4902 words: Missing offer/benefits section; Salary/baseSalary missing or not specific
...
1. Add 7 missing job(s) to website
2. Remove 11 closed job(s) from website
