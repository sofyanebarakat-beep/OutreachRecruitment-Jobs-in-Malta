# Job Sync Report — 2026-09-11

Generated: 2026-09-11T09:15:49

## Summary

| Metric | Value |
|---|---|
| Careers Page Jobs | 177 |
| Careers Jobs Scraped | 177 |
| Website Jobs | 183 |
...
2. Fix 76 job URL(s) with zero Search Console impressions
3. Fix 31 job URL(s) ranking worse than average position 20
4. Fix 60 job URL(s) missing target keyword visibility in top queries
...
- **[Sales Executive](https://outreachrecruitment.net/jobs/sales-executive)**: target `Sales Executive jobs in Malta`
...
- **[Trailer Drivers](https://outreachrecruitment.net/jobs/trailer-drivers)**: avg position 21.6, top query `agency name`
- **[Assistant Executive Housekeeper](https://outreachrecruitment.net/jobs/assistant-executive-housekeeper)**: avg position 25.3, top query `executive housekeeper`
...
- **[HR Administration Officer](https://outreachrecruitment.net/jobs/hr-administration-officer)**: avg position 37.8, top query `human resources administration jobs`
...
- **[Client Accountant](https://outreachrecruitment.net/jobs/client-accountant)**: avg position 26.4, top query `accounting recruitment malta`
...
- **[Airline Sales, Reservations, and Ticketing Officer](https://outreachrecruitment.net/jobs/airline-sales-reservations-and-ticketing-officer)**: avg position 37.6, top query `airline ticketing officer`
...
- **[Driver - Malta C License](https://outreachrecruitment.net/jobs/driver-malta-c-license)**: avg position 41.8, top query `malta driver jobs`
- **[Assistant Laboratory Manager - Construction Materials](https://outreachrecruitment.net/jobs/assistant-laboratory-manager-construction-materials)**: avg position 69.2, top query `site:outreachrecruitment.net`
...
- **[Corporate Insurance Associate](https://outreachrecruitment.net/jobs/corporate-insurance-associate)**: avg position 39.5, top query `insurance recruitment agency malta`
- **[Delivery Drivers - C1 Malta License](https://outreachrecruitment.net/jobs/delivery-drivers-c1-malta-license)**: avg position 36.8, top query `delivery driver`
...
- **[Commercial Insurance Associate](https://outreachrecruitment.net/jobs/commercial-insurance-associate)**: avg position 37.2, top query `insurance recruitment agency malta`
- **[Hotel Porter](https://outreachrecruitment.net/jobs/hotel-porter)**: avg position 46.5, top query `hotel porter jobs`
- **[Boat Maintenance](https://outreachrecruitment.net/jobs/boat-maintenance)**: avg position 75.0, top query `site:outreachrecruitment.net`
...
- **[Hairdresser](https://outreachrecruitment.net/jobs/hairdresser)**: target `Hairdresser jobs in Malta`, top query `site:outreachrecruitment.net`
